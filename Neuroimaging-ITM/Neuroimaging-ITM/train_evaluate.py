    ...
    with tf.Session() as sess:
        ...
        for iter in range(config.nepochs+1):
            ...
            if es_epoch==iter:
                    ...
                    break
        print("Copy out later")
        trueNER_List, predNER_List, trueRel_List, predRel_List = model.evaluate2(test_data, operations, 'test')
        even= find.even(trueNER_List, predNER_List, trueRel_List, predRel_List)
        even.getPrint();
