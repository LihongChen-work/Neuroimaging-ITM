...
# ===================================================================================
        ...
        self.train_id_docs = parsers.readHeadFile(self.filename_train)[0]
        self.dev_id_docs, dev_headfile = parsers.readHeadFile( self.filename_dev)
        self.test_id_docs, test_headfile = parsers.readHeadFile(self.filename_test)
        tag.old_data(test_headfile)
