...
#使用严格、边界和宽松的评估方法计算和打印结果的类和方法集。              有关如何使用它们的详细信息，请参见tf_utils.py
...
class chunkEvaluator:
    ...
    def add2(self, pred_batchesNER, true_batchesNER, pred_batchesREL, true_batchesREL,n,i):
        ...
        for batch_idx in range(len(pred_batchesNER)):
            ...
            # tag.old_data()
            tag.ttag(lab_chunks, trueRel, n, i,'true')
            tag.ttag(lab_pred_chunks, predRel, n, i, 'pred')
            ...
            if self.ner_chunk_eval == "boundaries_type":
                ...
                #         ======================================================================
                # tag.ttag(lab_chunks, lab_pred_chunks, trueRel, predRel, tagsNER)
                # ===============================================================================
